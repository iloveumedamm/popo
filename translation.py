START_MESSAGE = "**Hi {}\n\nI'm a bot that search for movies in the Url format. Simply send me the title of a film and I'll send it to you if it's in my database Click On Help Button For More Info.**"
